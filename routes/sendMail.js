...
import { sendMail, sendMailWithAttachment, sendMailWithAttachmentWithoutId } from "../controllers/sendMail.js";

const sendMailRouter = Router();
// :collectionReportId
sendMailRouter.post('/', auth,  logUserAction('Created payment for Sell'),sendMail);
sendMailRouter.post('/attachment', auth,  logUserAction('Created payment for Sell'),sendMailWithAttachmentWithoutId);
